...
@if (session('success'))
    ...
    @endif
      ...
      <button data-bs-toggle="modal" data-bs-target="#default_modal" class="btn inline-flex justify-center btn-outline-dark capitalize">Add Student</button>
              ...
              <div class="p-6 space-y-4">
                <form action="{{ route('form.post') }}" method="POST">
                    ...
                    <div class="input-area relative">
                      ...
                      <div class="input-area relative mb-3" id="phone-area">
                        <label for="phone_number" class="form-label">Phone</label>
                        <input type="number" name="phone_number[]" class="form-control border-2 mb-2" placeholder="Phone">
            ...
            <td class="table-td">
                <div class="flex space-x-3 rtl:space-x-reverse">
                    <button class="action-btn" type="button">
                        <a href="{{ route('detail', ['id' => $item->id]) }}"><iconify-icon icon="heroicons:eye"></iconify-icon></a>
                    </button>
                    <button class="action-btn" type="button">
                        <a href="{{ route('data.edit', ['id' => $item->id]) }}"><iconify-icon icon="heroicons:pencil-square"></iconify-icon></a>
                    </button>
...
<button id="openModalBtn" class="px-6 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none">
    Buka Form
  </button>
