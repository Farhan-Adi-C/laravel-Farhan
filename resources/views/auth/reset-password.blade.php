    ...
    <div class="card">
        <div class="card-body flex flex-col p-6">
          <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
            <div class="flex-1">
              <div class="card-title text-slate-900 dark:text-white text-center">Reset Password Email</div>
            </div>
          </header>
          <div class="card-text h-full ">
            <form class="space-y-4" method="POST" action="{{ route('password.update') }}">
              ...
              <div class="input-area relative pl-28">
                ...
                <div class="relative">
                  <input type="password" id="password" name="password" class="form-control !pl-9" placeholder="Password">
                  {{-- <iconify-icon icon="heroicons-outline:mail" class="absolute left-2 top-1/2 -translate-y-1/2 text-base text-slate-500"></iconify-icon> --}}
                </div>
              </div>
              
              <div class="input-area relative pl-28">
                <label for="repassword" class="inline-inputLabel">Retype Password</label>
                <div class="relative">
                  <input type="repassword" id="repassword" name="password_confirmation" class="form-control !pl-9" placeholder="ReType your password">
                  {{-- <iconify-icon icon="heroicons-outline:mail" class="absolute left-2 top-1/2 -translate-y-1/2 text-base text-slate-500"></iconify-icon> --}}
                </div>
              </div>
              ...
              <div class="input-area relative pl-28">
                <div class="relative">
                  <input type="hidden" value="{{ $token }}" id="token" name="token" class="form-control !pl-9" >
                  {{-- <iconify-icon icon="heroicons-outline:mail" class="absolute left-2 top-1/2 -translate-y-1/2 text-base text-slate-500"></iconify-icon> --}}
                </div>
              </div>
