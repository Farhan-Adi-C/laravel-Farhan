    ...
    <div class="sidebar-wrapper group">
      ...
      <div class="logo-segment">
        <a class="flex items-center" href="index.html">
          ...
          <span class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">Farhan Adi</span>
        </a>
        <!-- Sidebar Type Button -->
        ...
        <ul class="sidebar-menu">
          ...
          {{-- <li class="">
            ...
            <ul class="sidebar-submenu">
              <li>
                <a href="{{ route('data') }}">Student List</a>
              </li>
              <li>
                <a href="{{ route('form') }}">Add Student</a>
              </li>
            </ul>
          </li> --}}
          
          <li class="">
            <a href="{{ route('data') }}" class="navItem">
              <span class="flex items-center">
            <iconify-icon class=" nav-icon" icon="ph:student"></iconify-icon>
            <span>Student</span>
              </span>
          ...
          <!-- Map -->
          <li class="">
            <a href="{{ route('phone') }}" class="navItem">
              <span class="flex items-center">
            <iconify-icon class=" nav-icon" icon="line-md:phone-call-loop"></iconify-icon>
            <span>Phone</span>
              </span>
            </a>
          </li>
          ...
          {{-- <li class="">
            <a href="javascript:void(0)" class="navItem">
              <span class="flex items-center">
            <iconify-icon class=" nav-icon" icon="material-symbols:add-reaction-outline"></iconify-icon>
            <span>Hobby</span>
              </span>
              <iconify-icon class="icon-arrow" icon="heroicons-outline:chevron-right"></iconify-icon>
            </a>
            <ul class="sidebar-submenu">
              ...
              <li>
                <a href="{{ route('detail.hobby') }}">Detail Hobby</a>
              </li>
              <li>
                <a href="{{ route('hobby.add') }}">Add Hobby</a>
              </li>
            </ul>
          </li> --}}

          <li class="">
            <a href="{{ route('detail.hobby') }}" class="navItem">
              <span class="flex items-center">
            <iconify-icon class=" nav-icon" icon="material-symbols:add-reaction-outline"></iconify-icon>
            <span>Hobbies</span>
              </span>
    ...
    <div class="flex flex-col justify-between min-h-screen">
      ...
      overflow-hidden">
                    <ul class="py-1 text-sm text-slate-800 dark:text-slate-200">
                      <li>
                        <a href="{{ route('data') }}" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
                          <iconify-icon icon="heroicons-outline:user" class="relative top-[2px] text-lg ltr:mr-1 rtl:ml-1"></iconify-icon>
                          <span class="font-Inter">Menu</span>
                        </a>
                      </li>
