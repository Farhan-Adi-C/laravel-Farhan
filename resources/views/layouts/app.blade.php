        ...
        <div class="sidebar-wrapper group">
            ...
            <div class="logo-segment">
                <a class="flex items-center" href="index.html">
                    ...
                    <span class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">Farhan
                        Adi</span>
                </a>
                <!-- Sidebar Type Button -->
            ...
            <ul class="sidebar-submenu">
              ...
              <li>
                <a href="{{ route('form') }}">Add Student</a>
                            ...
                            <a href="{{ route('detail.hobby') }}" class="navItem">
                                <span class="flex items-center">
                                    <iconify-icon class=" nav-icon"
                                        icon="material-symbols:add-reaction-outline"></iconify-icon>
                                    <span>Hobbies</span>
                                </span>
                            </a>
                        </li>
                    ...
                    @role('super-admin')
                        <li class="sidebar-menu-title">Advanced</li>

                        <li class="">
                            <a href="javascript:void(0)" class="navItem">
                                <span class="flex items-center">
                                    <iconify-icon class=" nav-icon" icon="mdi:user-outline"></iconify-icon>
                                    <span>User</span>
                                </span>
                                <iconify-icon class="icon-arrow" icon="heroicons-outline:chevron-right"></iconify-icon>
                            </a>
                            <ul class="sidebar-submenu">
                                ...
                                <li>
                                    <a href="{{ route('user') }}">Detail Users</a>
                                </li>
                    ...
                    @endrole
                    <div class="mt-10">
                        <li class="sidebar-menu-title mt-10">
                            As : <b>{{ ucfirst(auth()->user()->getRoleNames()->first()) }}</b>
                        </li>
                    </div>
