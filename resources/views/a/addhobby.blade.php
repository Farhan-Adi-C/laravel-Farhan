...
@endif
    ...
    <form action="{{ route('add.hobby.post', ['id' => $data->id]) }}" method="POST" class="max-w-lg mx-auto p-6 border border-gray-300 rounded-lg shadow-lg">
        @csrf
        ...
        <div class="justify-center mx-auto text-center">
            ...
            <a href="{{ route('detail.hobby', ['id' => $id]) }}" class="text-center inline-block bg-slate-500 rounded-md px-4 py-2 text-white">Kembali</a>
        </div>
    </form>
</body>
</html>
